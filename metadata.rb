...
recipe            "chef-client::maintenance", "Restart chef-client nightly because it leaks"

%w{ ubuntu debian redhat centos fedora oracle suse freebsd openbsd mac_os_x mac_os_x_server windows smartos }.each do |os|
  supports os
end
